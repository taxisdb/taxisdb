...
- ☁️ The complete source code of a service stack if you offer TaxisDB as a hosted service
...
→ No source release required

IF you build an application using TaxisDB
→ Your application can remain closed-source

IF you modify TaxisDB and distribute it
→ SSPLv1 obligations apply

IF you offer TaxisDB as a hosted/cloud service
→ Your complete service source code must be released under SSPLv1

IF you want a proprietary hosted service
...
```text
SSPLv1:
  • Strong copyleft license for server-side software.
  • Internal use and applications built with TaxisDB are allowed.
  • Hosted services using TaxisDB must release the complete service
    source code required by SSPLv1.

Commercial License:
  • Required for proprietary cloud services or deployments that do not
    want to comply with SSPLv1 service obligations.
  • Designed for companies, startups, cloud providers, and OEM partners.
```
