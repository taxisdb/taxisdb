...
- For developers visit:
	...
	- [Contributor License Agreement (CLA)](https://taxisdb.com/docs/contributor-license-agreement-cla/) —  The legal agreement contributors must accept before submitting code, schema, or content to the TaxisDB Platform, covering copyright, licensing, and patent terms.